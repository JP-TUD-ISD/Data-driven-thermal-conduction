...
C = [290.0 * 2400, 300.0 * 2400, 810.0 * 2400, 810.0 * 2400, 970.0 * 2400]  # heat capacity per domain 
...
if syntdata:
    ...
    # then nDB needs to be the length of each data set... should be doable in Python
...
idx = np.zeros((nSteps+1,N),dtype=int)  # hmmmm I think this is an index pointing to the best data point set
